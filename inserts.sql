--psql -U postgres -d chat_project
...
-- 3. Link Users to Channels (UsersInChannel)
...
-- 4. Set their current Active Channel (UserInActiveChannel)
INSERT INTO UserInActiveChannel (username, channel) VALUES 
('TestUser', 'General'),
('Me', 'General'),
('Alice', 'Dev');

-- 5. Insert Messages into the channels
